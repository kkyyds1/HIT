...
sys.path.append('..')
from config import other_config as config
...
class PDDL_Parser:
    ...
    def __init__(self):
        ...
        gen_domain(config)
        gen_problem(config)
        domain = config.domain_config['domain_path']
        instance = config.problem_config['problem_path']
        # parser = PDDL_Parser()
        self.parse_domain(domain)
    
        if instance:
            self.parse_problem(instance)
        self.state_to_tuple()
    # -----------------------------------------------
    # Tokens
    # -----------------------------------------------
